...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        val navview: DrawerLayout = findViewById(R.id.homesc)
        val imageView3: ImageView = findViewById(R.id.imageView3)
        drawerLayout = findViewById(R.id.homesc)
        imageView3.setOnClickListener {
            navview.openDrawer(GravityCompat.START)
        }

        val pg1:ImageView = findViewById(R.id.imageView4)
        val pg2:ImageView = findViewById(R.id.imageView7)
